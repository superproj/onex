...
import (
	apiscoordinationv1 "github.com/superproj/onex/pkg/apis/coordination/v1"
...
// Experimental!
func ExtractLease(lease *apiscoordinationv1.Lease, fieldManager string) (*LeaseApplyConfiguration, error) {
...
// Experimental!
func ExtractLeaseStatus(lease *apiscoordinationv1.Lease, fieldManager string) (*LeaseApplyConfiguration, error) {
	return extractLease(lease, fieldManager, "status")
}

func extractLease(lease *apiscoordinationv1.Lease, fieldManager string, subresource string) (*LeaseApplyConfiguration, error) {
	b := &LeaseApplyConfiguration{}
	err := managedfields.ExtractInto(lease, internal.Parser().Type("com.github.superproj.onex.pkg.apis.coordination.v1.Lease"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
