...
// EvaluatePhase is a string representation of a Miner Phase.
...
type EvaluateStatus struct {
	...
	// +optional
	ArthurID *string `json:"arthurID,omitempty" protobuf:"bytes,6,opt,name=arthurID"`
	...
	// +optional
	Phase string `json:"phase,omitempty" protobuf:"bytes,7,opt,name=phase"`
...
// GetConditions returns the set of conditions for the Evaluate.
func (eva *Evaluate) GetConditions() Conditions {
	return eva.Status.Conditions
}

// SetConditions updates the set of conditions on the Evaluate.
func (eva *Evaluate) SetConditions(conditions Conditions) {
	eva.Status.Conditions = conditions
}
