...
// 用户操作被禁止，可能是由于权限不足或其他安全限制导致的
func ErrorUserOperationForbidden(format string, args ...any) *errors.Error {
...
// 密钥达到最大数量限制，无法继续创建新密钥
func ErrorSecretReachMaxCount(format string, args ...any) *errors.Error {
...
// 密钥未找到，可能是由于密钥不存在或输入的密钥标识有误
func ErrorSecretNotFound(format string, args ...any) *errors.Error {
...
// 创建密钥失败，可能是由于服务器或其他问题导致的创建过程中的错误
func ErrorSecretCreateFailed(format string, args ...any) *errors.Error {
