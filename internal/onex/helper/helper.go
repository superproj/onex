...
//
// Adapted from github.com/go-nunu/nunu/internal/pkg/helper (MIT licensed),
// inlined here because onex cannot import nunu's internal packages.
...
// GetProjectName reads the module name from dir/go.mod.
...
// SplitArgs splits args at the "--" separator into cobra args and program args.
...
// FindMain walks base and returns a map of main file path -> directory.
