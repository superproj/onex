...
# not. We should run `scripts/update-generated-swagger-docs.sh` if swagger type
# documentation is out of date.
# Usage: `scripts/verify-generated-swagger-docs.sh`.
...
_tmpdir="$(onex::realpath "$(mktemp -d -t swagger-docs.XXXXXX)")"
function swagger_cleanup {
  rm -rf "${_tmpdir}"
}
onex::util::trap_add swagger_cleanup EXIT
