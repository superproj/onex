...
Manage minersets on onex platform
...
```
onexctl minerset SUBCOMMAND
```

### Options

```
  -h, --help   help for minerset
```
...
* [onexctl minerset list](onexctl_minerset_list.md)	 - Display all minerset resources
